        ...
        Column
        {
            ...
            Item {
                ...
                Text {
                    ...
                    font.bold: true
                    font.pixelSize: 20
                    text: '<html><style type="text/css" color="white"></style><a href="' + a_link + '">BypassNAT</a></html>'
                    onLinkActivated: Qt.openUrlExternally(a_link)

                    property string  a_link: "https://in-spectrum.github.io/BypassNAT/"
                ...
                Text {
                    ...
                    property string  a_link: "https://github.com/In-spectrum/BypassNAT?tab=readme-ov-file"
                ...
                Text {
                    ...
                    property string  a_link: "https://github.com/In-spectrum/BypassNAT?tab=MIT-1-ov-file#"
