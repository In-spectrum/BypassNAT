...
Item {
    ...
    function fVideoStartStop(_sUrl, _iVar)
    {
        ...
        showVideoFilter.m_bFrameNew = true;
        showVideoFilter.m_iFramePrew = 0;
    ...
    function fVideoReload()
    {
        ...
        if(showVideoFilter.m_iFramePrew < 0)
        {
            showVideoFilter.m_bFrameNew = false;
        ...
        showVideoFilter.m_iFramePrew = -1;
    ...
    Item {
        ...
        property int m_iFrameW: videoOutput.sourceRect.width
        property int m_iFrameH: videoOutput.sourceRect.height
        ...
        MediaPlayer {
               ...
               onStatusChanged:
               {
                   ...
                   print("player status: code " + status);
        ...
        MyFilter {
            ...
            onFrameNumChanged :
            {
                ...
                root.m_iPlayRestart = 0;
                showVideoFilter.m_bFrameNew = true;
                showVideoFilter.m_iFramePrew = frameNum;

                root.m_iFPS++;

                //print("showVideoFilter 0: " + frameNum)
                //print("showVideoFilter 1: " + m_iFramePrew + " / " + m_bFrameNew)
    ...
    Item {
        ...
        y:2
        rotation: 0
        visible: root.m_sURL.length > 0 && !showVideoFilter.m_bFrameNew ? true : false
