  ...
  * [**FaNAT-client-lite**](#fanat-client-lite)
	* [Available](#available-1)
  	...
  	* [Установка](#install-2)
		* [Windows](#windows-1)
		* [Ubuntu](#ubuntu-1)
  * [**FaNAT-client-console**](#fanat-client-console)
...
<p style="font-size:24px; ">&emsp;&emsp;&emsp;*если клиент подключён и не используется - он будет отключен от сервера через 60сек.<br>
&emsp;&emsp;&emsp;&ensp;Через 30сек. клиент переподключится к серверу для повторной идентификации в сети.</p>
...
_*требуется установку дополнительного ПО_
...
- обмен файлами;
- запуск приложения с дополнительными параметрами п. 2.3.4 (url);
